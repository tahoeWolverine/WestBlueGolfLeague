...
<HTML>
<HEAD>
	<TITLE>West Blue Golf League - <%= strYear %> Standings</TITLE>
</HEAD>

<BODY bgcolor="white"> 
<center><h2><font color="Green"><% Response.write(strYear & " Standings")%></font></h2></center>
<%
...
Do While Not RSA.EOF
	...
	Do While Not RS2.EOF
		...
		RS2.MoveNext
	Loop
	Set RS = Conn.Execute("SELECT DISTINCT Week FROM ResultsTable WHERE TeamID1='" & TeamAArray(j) & "' OR TeamID2='" & TeamAArray(j) & "'")
	Do While Not RS.EOF
		WeeksCount = WeeksCount + 1
		RS.MoveNext
	Loop
	WeeksAArray(j) = WeeksCount 
...
<br><br>
<!--<center><a href="stand00.asp">2000 Final Standings</a></center><br>
<center><a href="stand99.html">1999 Final Standings</a></center><br>
