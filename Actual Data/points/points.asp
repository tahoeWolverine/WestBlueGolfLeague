...
<HTML>
<HEAD>
	<TITLE>West Blue Golf League - <%= strYear %> Points</TITLE>
</HEAD>

<BODY bgcolor="white">
<center><h2><font color="Green"><%= strYear %> Points</font></h2></center>
<br>
<br>
<%
...
<tr>
    <td>
		<table>
			...
			<tr>
			    <td><form action="pPlay.asp" method="GET">
    ...
    <td>
		<table>
			...
			<tr>
			    <td>
					<form action="pTeam.asp" method="GET">
					<input type=hidden name=Year value=<%= strYear %>>
