...
CREATE INDEX `fk_week_pairing1_idx` ON `westbluegolf`.`week` (`pairingId` ASC);
...
CREATE TABLE IF NOT EXISTS `westbluegolf`.`teamMatchup` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `playoffType` VARCHAR(75) NULL,
  `weekId` INT NOT NULL,
  `matchComplete` TINYINT(1) NOT NULL,
  `startTimeId` INT NULL,
  `matchId` INT NULL,
  `matchupType` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
CREATE INDEX `fk_matchup_team_matchup1_idx` ON `westbluegolf`.`match` (`teamMatchupId` ASC);
...
CREATE INDEX `fk_result_matchup1_idx` ON `westbluegolf`.`result` (`matchId` ASC);
...
CREATE INDEX `fk_matchupToPlayer_player1_idx` ON `westbluegolf`.`matchToPlayer` (`playerId` ASC);

CREATE INDEX `fk_matchupToPlayer_matchup1_idx` ON `westbluegolf`.`matchToPlayer` (`matchId` ASC);
...
-- -----------------------------------------------------
-- Data for table `westbluegolf`.`pairing`
-- -----------------------------------------------------
START TRANSACTION;
USE `westbluegolf`;
INSERT INTO `westbluegolf`.`pairing` (`id`, `pairingText`) VALUES (1, '1-2, 3-4');
INSERT INTO `westbluegolf`.`pairing` (`id`, `pairingText`) VALUES (2, '1-3, 2-4');
INSERT INTO `westbluegolf`.`pairing` (`id`, `pairingText`) VALUES (3, '1-4, 2-3');
...
START TRANSACTION;
USE `westbluegolf`;
INSERT INTO `westbluegolf`.`user` (`id`, `username`, `passwordHash`, `salt`, `dateAdded`, `email`, `role`) VALUES (1, 'admin', '4AE41260B4CA1A93852A3F05CE1D90D85DE30224CD0539331BAD671E4A1D1A00', '839202910', '2014-04-19', 'polaris878@gmail.com', 'admin');
